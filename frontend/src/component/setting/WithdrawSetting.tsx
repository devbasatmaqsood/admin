...
const WithdrawSetting = () => {
  ...
  // useEffect(() => {
  //   setMinWithdrawalRequestedCoin(setting?.minWithdrawalRequestedCoin);
  // }, [setting]);
  ...
  const withdrawTable = [
    ...
    },
    {
      ...
      body: 'image',
      Cell: ({ row, index }) => (
        <img src={row?.image} style={{ objectFit: 'cover', width: '100px' }} />
      ),
    },
    {
      Header: 'NAME',
      ...
      Cell: ({ row }) => (
        <div className="action-button">
          ...
          <button
            ...
            onClick={() => handleDeleteWithdraw(row?._id)}
          >
            <svg
              width="26"
              height="26"
